...
import { SeqConflict, MatchStateError, DecisionRequired, ValidationError } from './match/events.js'
...
export function createApp(ctx: AppContext) {
  ...
  app.onError((err, c) => {
    ...
    if (err instanceof ValidationError) return errorJson(c, 422, 'validation', err.message)
